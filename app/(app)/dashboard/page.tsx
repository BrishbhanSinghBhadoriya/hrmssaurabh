...
import { Calendar as MiniCalendar } from '@/components/ui/calendar';
 import CounselorKRAPanel from '@/components/salary/CounselorKRAPanel';
 import CounselorVerificationPanel from '@/components/salary/CounselorVerificationPanel';
 dayjs.extend(relativeTime);
 ...
 export default function DashboardPage() {
   ...
   const isCounselor = user?.designation?.toLowerCase().includes("counselor");
   const isManager = userRole === "manager" || userRole === "hr" || userRole === "admin";
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl border">
       ...
       {/* Counselor KRA / Manager Verification */}
       <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
         {isCounselor && (
           <div className="lg:col-span-12 xl:col-span-8">
             <CounselorKRAPanel token={token} />
           </div>
         )}
         {isManager && (
           <div className="lg:col-span-12">
             <CounselorVerificationPanel />
           </div>
         )}
       </div>
